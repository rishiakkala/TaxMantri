    ...
    <div>
      ...
      <AnimatePresence mode="wait">
        {phase === 'idle' || phase === 'uploading' ? (
          ...
          >
            {ocrSummary && ocrSummary.green_count === 0 ? (
              /* ── No fields extracted ── */
              <>
                <div className="flex items-center gap-2 mb-6 text-red-500 font-medium text-sm">
                  <XCircle className="w-5 h-5 flex-shrink-0" />
                  Could not extract fields from the form. Please re-upload a clearer file.
                </div>
                <button
              ...
              <>
                {/* Success message */}
                <div className="flex items-center gap-2 mb-6 text-success font-medium text-sm">
                  <CheckCircle className="w-5 h-5 flex-shrink-0" />
                  Extracted required fields from the form
                </div>
